...
class EmployeeInfoForm(forms.ModelForm):
    position = forms.CharField(label="", max_length=100, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Position'}))
    date_of_birth = forms.DateField(label="", widget=forms.DateInput(attrs={'class':'form-control', 'placeholder':'Date of Birth'}))
    ...
    salary = forms.DecimalField(label="", max_digits=10, decimal_places=2, widget=forms.NumberInput(attrs={'class':'form-control', 'placeholder':'Salary'}))
	
    class Meta:
        model = Employee
        fields = ['position', 'date_of_birth', 'phone_number', 'address', 'salary']
